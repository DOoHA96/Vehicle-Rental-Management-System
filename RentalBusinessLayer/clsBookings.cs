...
namespace RentalBusinessLayer
{
    public class clsBookings
    {
        ...
        {
            this.BookingID = clsBookingsData.AddNewBookings(this.CustomerID, this.VehicleID, this.StartDate, this.EndDate, this.DropoffLocation, this.PickupLocation, this.PricePerDay, this.InitialTotalDueAmount, this.Notes, this.Status, this.CreatedByUserID);

            return (this.BookingID != null);
        }
        private bool _Update()
        {
            return clsBookingsData.UpdateBookings(this.BookingID, this.CustomerID, this.VehicleID, this.StartDate, this.EndDate, this.DropoffLocation, this.PickupLocation, this.PricePerDay, this.InitialTotalDueAmount, this.Notes, this.Status, this.CreatedByUserID);
        }
        public static clsBookings Find(int? BookingID)
        {
            ...
            bool? IsFound = clsBookingsData.GetBookingsInfoByID(BookingID, ref CustomerID, ref VehicleID, ref StartDate, ref EndDate, ref DropoffLocation, ref PickupLocation, ref PricePerDay, ref InitialTotalDueAmount, ref Notes, ref Status, ref CreatedByUserID);
        ...
        {
            return clsBookingsData.DeleteBookings(BookingID);
        }
        public static DataTable GetAll()
        {
            return clsBookingsData.GetAllBookings();
        }
