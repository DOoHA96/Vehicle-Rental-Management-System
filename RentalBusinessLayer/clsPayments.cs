...
namespace RentalBusinessLayer
{
    public class clsPayments
    {
        ...
        {
            this.PaymentID = clsPaymentsData.AddNewPayments(this.BookingID, this.ReturnID, this.Details, this.InitialPaidTotalDueAmount, this.ActualTotalDueAmount, this.TotalRemaining, this.TotalRefundedAmount, this.PaymentDate, this.UpdatedPaymentDate, this.CreatedByUserID);
                                                 
            return (this.PaymentID != null);
        }
        private bool _Update()
        {
            return clsPaymentsData.UpdatePayments(this.PaymentID, this.BookingID, this.ReturnID, this.Details, this.InitialPaidTotalDueAmount, this.ActualTotalDueAmount, this.TotalRemaining, this.TotalRefundedAmount, this.PaymentDate, this.UpdatedPaymentDate, this.CreatedByUserID);
        }
        public static clsPayments Find(int? PaymentID)
        {
            ...
            bool? IsFound = clsPaymentsData.GetPaymentsInfoByID(PaymentID, ref BookingID, ref ReturnID, ref Details, ref InitialPaidTotalDueAmount, ref ActualTotalDueAmount, ref TotalRemaining, ref TotalRefundedAmount, ref PaymentDate, ref UpdatedPaymentDate, ref CreatedByUserID);
