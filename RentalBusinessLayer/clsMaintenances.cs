...
namespace RentalBusinessLayer
{
    public class clsMaintenances
    {
        ...
        {
            this.MaintenanceID = clsMaintenancesData.AddNewMaintenances(this.VehicleID, this.Description, this.MaintenanceDate, this.Cost, this.Status, this.CreatedByUserID);

            return (this.MaintenanceID != null);
        }
        private bool _Update()
        {
            return clsMaintenancesData.UpdateMaintenances(this.MaintenanceID, this.VehicleID, this.Description, this.MaintenanceDate, this.Cost, this.Status, this.CreatedByUserID);
        }
        public static clsMaintenances Find(int? MaintenanceID)
        {
            ...
            bool? IsFound = clsMaintenancesData.GetMaintenancesInfoByID(MaintenanceID, ref VehicleID, ref Description, ref MaintenanceDate, ref Cost, ref Status, ref CreatedByUserID);
        ...
        {
            return clsMaintenancesData.DeleteMaintenances(MaintenanceID);
        }
        ...
        {
            return clsMaintenancesData.ReleaseVehicleAfterMaintenance(MaintenanceID, VehicleID) != null;
        }
