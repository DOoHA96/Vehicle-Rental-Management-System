...
namespace Forms2.Booking
{
    ...
    {
        public frmListBookings(frmMain frmMain)
        {
            InitializeComponent();
            _frmMain = frmMain;
        }
        ...
        private void txtBookingFilterValue_TextChanged(object sender, EventArgs e)
        {
            _dtBookings.DefaultView.RowFilter = $"Customer  likE '{txtBookingFilterValue.Text}%' or Vehicle LIke '{txtBookingFilterValue.Text}%'";
        }
